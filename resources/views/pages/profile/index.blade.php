    ...
    <div class="container" style="margin-top: 10px;">
        @if (Auth::check())
            <div class="text-center">
                <h1
                    style="font-size: 40px; color: #0dc225; font-weight: bold; font-family: 'Georgia', serif; text-shadow: 2px 2px 4px rgba(0, 0, 0, 0.2);">
                    Profile {{ Auth::user()->role === 'admin' ? 'Admin' : 'Author' }}
                </h1>
                <div class="profile-info border p-4 rounded mt-4"
                    style="background-color: #ffffff; width: 450px; margin: 0 auto; box-shadow: 0 4px 15px rgba(0, 0, 0, 0.1); border-radius: 15px;">
                    <h2 style="font-size: 22px; color: #4fa94f; font-weight: bold;">Informasi Pribadi</h2>
                    <div
                        style="text-align: left; padding: 15px; background-color: #f3f7f2; border-radius: 10px; margin-top: 20px;">
