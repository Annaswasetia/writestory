...
<div class="container my-5">
    ...
    <div class="text-center mb-5" style="margin-top: 50px;">
        ...
        <p class="lead text-muted" style="font-family: 'Open Sans', sans-serif; font-size: 18px;">Hai kamu yang menemukannya. Nikmatilah puisi ini, karena setiap
    ...
    <div class="row">
        ...
        <div class="col-12 col-md-6 mb-4" style="padding-top: 50px">
            <div class="card shadow-lg h-100" style="border-radius: 15px; overflow: hidden; transition: transform 0.3s;">
                <div class="card-body d-flex flex-column">
                    <!-- Title -->
                    <h4 class="card-title" style="color: rgb(13, 194, 37); font-family: 'Georgia', serif; font-weight: bold;">
                        {{ $item->title }}
                    </h4>
